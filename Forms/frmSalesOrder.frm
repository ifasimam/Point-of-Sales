...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmSalesOrderAE.State = adStateAddMode
            frmSalesOrderAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Sales_Order", "SalesOrderID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "This record has been removed by other user. Click 'OK' button to refresh the records.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmSalesOrderAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Sales_Order", "SalesOrderID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "SONo, Company, Date, Salesman, QtyOrdered, QtyRcvd, QtyDue, SalesOrderID"
        .Tables = "qry_Sales_Order"
        .SortOrder = "Date DESC"
    ...
    rsSalesOrder.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsSalesOrder, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsSalesOrder, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "SalesOrderID")
    Me.Enabled = True
