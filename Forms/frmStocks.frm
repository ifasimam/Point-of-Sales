    ...
    Select Case srcPerformWhat
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    Dim ANS As Integer
                    ANS = MsgBox("Apakah anda yakin akan menghapus data ini?" & vbCrLf & vbCrLf & "PERHATIAN: Anda tidak dapat mengembalikan data. Data akan dihapus secara permanen dari sistem.", vbCritical + vbYesNo, "Confirm Record Delete")
...
Private Sub Form_Load()
    ...
    With MAIN
        ...
        lvList.ColumnHeaders.Add , , "Barcode", 2000
        lvList.ColumnHeaders.Add , , "Nama Produk", 4000
        lvList.ColumnHeaders.Add , , "Nama Barcode", 3000
        lvList.ColumnHeaders.Add , , "Detil Produk", 3000
        lvList.ColumnHeaders.Add , , "ICode", 2000
        lvList.ColumnHeaders.Add , , "Reorder.Pt", 1000
        lvList.ColumnHeaders.Add , , "Kategori", 2150
        lvList.ColumnHeaders.Add , , "Stock ID", 0
    ...
    With SQLParser
        .Fields = "Barcode, Stock, Short1, Short2, ICode, ReorderPoint, Category, StockID"
        .Tables = "qry_Stocks"
        .SortOrder = "Stock ASC"
