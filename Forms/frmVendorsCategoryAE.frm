VERSION 5.00
Begin VB.Form frmVendorsCategoryAE 
   ...
   End
End
Attribute VB_Name = "frmVendorsCategoryAE"
...
Private Sub Form_Load()
    ...
    rs.Open "SELECT * FROM Vendors_Category WHERE CategoryID = " & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    If HaveAction = True Then
        If State = adStateAddMode Or adStateEditMode Then
            frmVendorsCategory.RefreshRecords
        End If
    End If
    
    Set frmVendorsCategoryAE = Nothing
End Sub
