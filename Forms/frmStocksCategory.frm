...
Begin VB.Form frmStocksCategory 
   ...
   End
End
Attribute VB_Name = "frmStocksCategory"
...
Dim rsStocks_Category As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmStocksCategoryAE.State = adStateAddMode
            frmStocksCategoryAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Stocks_Category", "CategoryID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "Data ini telah dihapus oleh user lain.Klik tombol 'OK' untuk merefresh halaman.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmStocksCategoryAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Stocks_Category", "CategoryID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        ...
        .Tables = "Stocks_Category"
        .SortOrder = "Category ASC"
        
        .SaveStatement
    End With
    rsStocks_Category.CursorLocation = adUseClient
    rsStocks_Category.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsStocks_Category, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsStocks_Category, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "CategoryID")
    Me.Enabled = True
