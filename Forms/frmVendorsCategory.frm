...
Begin VB.Form frmVendorsCategory 
   ...
   Begin VB.Label lblTitle 
      BackStyle       =   0  'Transparent
      Caption         =   "Daftar Kategori Supplier"
      BeginProperty Font 
         Name            =   "Tahoma"
         Size            =   8.25
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmVendorsCategory"
...
Dim rsVendors_Category As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmVendorsCategoryAE.State = adStateAddMode
            frmVendorsCategoryAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Vendors_Category", "CategoryID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
                    MsgBox "Data ini telah dihapus oleh user lain.Klik tombol 'OK' untuk merefresh halaman.", vbExclamation
                    RefreshRecords
                    Exit Sub
                Else
                    With frmVendorsCategoryAE
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    Dim ANS As Integer
                    ANS = MsgBox("Apakah anda yakin akan menghapus data yang dipilih ?" & vbCrLf & vbCrLf & "PERHATIAN: Anda tidak dapat mengembalikan data. Data akan dihapus secara permanen dari sistem.", vbCritical + vbYesNo, "Confirm Record Delete")
                    Me.MousePointer = vbHourglass
                    If ANS = vbYes Then
                        DelRecwSQL "Vendors_Category", "CategoryID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
                        MsgBox "Data berhasil dihapus dari sistem.", vbInformation, "Confirm"
                    End If
                    ANS = 0
                    Me.MousePointer = vbDefault
                End If
            Else
                MsgBox "Tidak ada data untuk dihapus.", vbExclamation
            End If
        Case "Refresh"
            RefreshRecords
        Case "Print"
...
Private Sub Form_Load()
    ...
    With MAIN
        ...
        'Set header name secara manual
        lvList.ColumnHeaders.Clear
        lvList.ColumnHeaders.Add , , "Kategori", 3000
    ...
    With SQLParser
        ...
        .Tables = "Vendors_Category"
        .SortOrder = "Category ASC"
        
        .SaveStatement
    End With
    rsVendors_Category.CursorLocation = adUseClient
    rsVendors_Category.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsVendors_Category, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsVendors_Category, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "CategoryID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmVendorsCategory = Nothing
End Sub
