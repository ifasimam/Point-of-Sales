...
Begin VB.Form frmStocksUOM 
   ...
   End
End
Attribute VB_Name = "frmStocksUOM"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmStocksUOMAE.State = adStateAddMode
            frmStocksUOMAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Unit", "UnitID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        DelRecwSQL "Unit", "UnitID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    rsUnit.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsUnit, RecordPage.PageStart, RecordPage.PageEnd, 2, 2, False, True, , , , "UnitID")
    Me.Enabled = True
