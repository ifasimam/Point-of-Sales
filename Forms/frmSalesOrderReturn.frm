...
Begin VB.Form frmSalesOrderReturn 
   ...
   End
End
Attribute VB_Name = "frmSalesOrderReturn"
...
Dim rsSalesOrderReturn As New Recordset
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmSalesOrderReturnAE.State = adStateAddMode
            frmSalesOrderReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Sales_Order_Return", "SalesOrderReturnID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Sales_Order_Return", "SalesOrderReturnID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "SONo, Company, DeliveryNo, DeliveryDate, QtyReturned, SalesOrderReturnID"
        .Tables = "qry_Sales_Order_Return"
        .SortOrder = "DeliveryDate DESC"
        
        .SaveStatement
    End With
    
    rsSalesOrderReturn.CursorLocation = adUseClient
    rsSalesOrderReturn.Open SQLParser.SQLStatement, CN, adOpenStatic, adLockReadOnly
    
    With RecordPage
        .Start rsSalesOrderReturn, 75
        FillList 1
    End With
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsSalesOrderReturn, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "SalesOrderReturnID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmSalesOrderReturn = Nothing
End Sub
