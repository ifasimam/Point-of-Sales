    ...
    Select Case srcPerformWhat
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    Dim ANS As Integer
                    ANS = MsgBox("Apakah anda yakin akan menghapus data ini?" & vbCrLf & vbCrLf & "PERHATIAN: Anda tidak dapat mengembalikan data. Data akan dihapus secara permanen dari sistem.", vbCritical + vbYesNo, "Confirm Record")
