VERSION 5.00
Begin VB.Form frmStocksCategoryAE 
   Caption         =   "Edit Entry"
   ClientHeight    =   1965
   ClientLeft      =   60
   ClientTop       =   450
   ...
   End
End
Attribute VB_Name = "frmStocksCategoryAE"
...
Private Sub Form_Load()
    ...
    rs.Open "SELECT * FROM Stocks_Category WHERE CategoryID = " & PK, CN, adOpenStatic, adLockOptimistic
...
Private Sub Form_Unload(Cancel As Integer)
    If HaveAction = True Then
        If State = adStateAddMode Or adStateEditMode Then
            frmStocksCategory.RefreshRecords
        End If
    End If
    
    Set frmStocksCategoryAE = Nothing
End Sub
