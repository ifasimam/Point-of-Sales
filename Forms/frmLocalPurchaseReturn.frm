...
Begin VB.Form frmLocalPurchaseReturn 
   ...
   End
End
Attribute VB_Name = "frmLocalPurchaseReturn"
...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmLocalPurchaseReturnAE.State = adStateAddMode
            frmLocalPurchaseReturnAE.show vbModal
        Case "Edit"
            If lvList.ListItems.Count > 0 Then
                If isRecordExist("Local_Purchase_Return", "VoucherID", CLng(LeftSplitUF(lvList.SelectedItem.Tag))) = False Then
        ...
        Case "Delete"
            If lvList.ListItems.Count > 0 Then
                ...
                Else
                    ...
                    If ANS = vbYes Then
                        'Remove
                        DelRecwSQL "Local_Purchase_Return", "VoucherID", "", True, CLng(LeftSplitUF(lvList.SelectedItem.Tag))
                        'Refresh the records
                        RefreshRecords
...
Private Sub Form_Load()
    ...
    With SQLParser
        .Fields = "Date, VoucherNo, InvoiceNo, PurchaseFrom, PaymentType, QtyReturned, Gross, Discount, NetAmount, VoucherID"
        .Tables = "qry_Local_Purchase_Return"
        .SortOrder = "Date DESC"
...
Private Sub FillList(ByVal whichPage As Long)
    ...
    Me.Enabled = False
    Call pageFillListView(lvList, rsLocalPurchase, RecordPage.PageStart, RecordPage.PageEnd, 16, 2, False, True, , , , "VoucherID")
    Me.Enabled = True
...
Private Sub Form_Unload(Cancel As Integer)
    ...
    Set frmLocalPurchaseReturn = Nothing
End Sub
