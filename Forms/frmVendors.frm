...
Public Sub CommandPass(ByVal srcPerformWhat As String)
    ...
    Select Case srcPerformWhat
        Case "New"
            frmVendorsAE.State = adStateAddMode
            frmVendorsAE.show vbModal
        Case "Edit"
...
Private Sub Form_Load()
    ...
    With MAIN
        ...
        lvList.ColumnHeaders.Add , , "No", 800
        lvList.ColumnHeaders.Add , , "Nomor Account", 1500
        lvList.ColumnHeaders.Add , , "Perusahaan", 3000
        lvList.ColumnHeaders.Add , , "Kategori", 1500
        lvList.ColumnHeaders.Add , , "Nama Depan", 2000
        lvList.ColumnHeaders.Add , , "Nama Belakang", 2000
        lvList.ColumnHeaders.Add , , "Jenis Kelamin", 1500
        lvList.ColumnHeaders.Add , , "Alamat", 7000
        lvList.ColumnHeaders.Add , , "Telepon", 1500
        lvList.ColumnHeaders.Add , , "Fax", 1500
        lvList.ColumnHeaders.Add , , "Email", 2000
        lvList.ColumnHeaders.Add , , "Website", 2000
    ...
    With SQLParser
        .Fields = "VendorID, AccountNo, Company, CategoryID, Firstname, Lastname, Gender, Address, Mobile, Fax, Email, Website"
        .Tables = "Vendors"
