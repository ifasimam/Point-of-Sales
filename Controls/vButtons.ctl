VERSION 5.00
Begin VB.UserControl vButtons_H 
   Appearance      =   0  'Flat
   AutoRedraw      =   -1  'True
   BackColor       =   &H00000000&
   ClientHeight    =   495
   ...
   ScaleMode       =   3  'Pixel
   ScaleWidth      =   89
   ToolboxBitmap   =   "vButtons.ctx":0000
End
Attribute VB_Name = "vButtons_H"
...
If Style < 0 Or Style > 8 Then Exit Property
...
Select Case myProps.bBackStyle
    ...
    Case 8: DrawButton_MacOSX polyPts(), polyColors(), ActiveStatus, ActiveClipRgn
End Select
...
Private Sub DrawButton_MacOSX(polyPts() As POINTAPI, polyColors() As Long, ActiveStatus As Integer, lastClipRgn As Integer)
'
End Sub
